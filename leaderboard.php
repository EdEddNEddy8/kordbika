...
if ($tabonline == 'Yes')
    echo 'class="active"';
?>><a data-toggle="tab" href="#all_clans"><i class="fa fa-users"></i>&nbsp; <?php
echo lang_key("all-clans");
?></a></li>
...
?>
                ...
                <!---Visi klani--->
                <div id="all_clans" class="tab-pane fade <?php
if ($tabonline == 'Yes')
    echo 'in active';
?>">
		    <center><h3><i class="far fa-dot-circle"></i> <?php
...
?></h3></center><br />
			...
			<table id="dt-basic3" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th><i class="fa fa-list-ol"></i></th>
						<th><i class="fa fa-user"></i> <?php
...
?></th>
					...
					<tbody>
<?php
$querygpo = mysqli_query($connect, "SELECT * FROM clans ORDER BY total_power DESC");
$c        = 1;
while ($rowgpo = mysqli_fetch_assoc($querygpo)) {
?>
                        <tr>
...
<td>
    <a href="clans.php?clan-id=<?php echo $rowgpo['id']; ?>" style="text-decoration: none;">
        <img src="<?php echo $rowgpo['avatar']; ?>" width="15%" />&nbsp; <?php echo $rowgpo['name']; ?>
    </a>
</td>
						    
                            
							<td><?php
    echo $rowgpo['total_power'];
?></td>
							<td><?php
    echo $rowgpo['zelts'];
?></td>
							...
							<td>
                                <a href="clans.php?clan-id=<?php echo $rowgpo['id']; ?>" style="text-decoration: none;"><i class="fa fa-map-marker"></i> <?php
    echo lang_key("visit-clan");
?></a> 
